...
ActiveRecord::Schema[7.1].define(version: 2025_10_28_125735) do
  ...
  create_table "vapi_agents", force: :cascade do |t|
    t.bigint "inbox_id", null: false
    t.bigint "account_id", null: false
  ...
  add_foreign_key "vapi_agents", "accounts"
  add_foreign_key "vapi_agents", "inboxes"
